...
def main_menu_keyboard_amharic():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🌟 የኢትዮጵያ ተማሪ ውጤት 🌟", callback_data="noop")],
        ...
        [InlineKeyboardButton("🌐 ቋንቋ መቀየር", callback_data="change_to_english"),
         InlineKeyboardButton("📝 አስተያየት መላክ", callback_data="feedback_amharic")],
